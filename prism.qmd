...
3. optimize/automation/make_tone_style.R: Half of participants will get their selected tone/style per baseline survey, half will be yoked to an existing tone/style. QUESTION: Do we instead use this to keep track of which of the 2x2x2x2 conditions each participant is assigned to, and tone/style are just part of that?
...
4. optimize/automation/download_followmee.R: 
   a. Input: `S:/other/credentials.csv`
   ...
   c. Run 4x day at 00:30, 06:30, 12:30, 18:30.
   d. **ready for Review**
...
7. optimize/automation/make_predictions.R:  
  ...
  b. Output: `S:/optimize/data_raw/$subid/predictions_$subid.csv` 
  c. Run 1x day
  d. **NEEDS CODING**
