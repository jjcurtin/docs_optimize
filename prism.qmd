...
1. optimize/automation/download_qualtrics.R: Download qualtrics surveys including screen, guid pedigree, baseline, ema, feedback, bimonthly
   a. Input: `S:/other/credentials.csv`
   b. Output: `S:/optimize/data_raw/surveys/` (one csv file for each distinct survey)
   c. Run 4?x/day at 00:00, 06:00, 12:00, 18:00
   d. **ready for Review**
   e. **FUTURE UPDATE**:Add consent, onboard, feedback (dependent on finalizing feedback survey form), and staff scripts. 
